<h1 align="center">Jalawan Aman Khan</h1>

<p align="center">
  <b>Full-Stack AI Engineer</b> &middot; building AI agents that automate real work
</p>

<p align="center">
  Agentic AI &middot; Multi-Agent &middot; RAG &middot; MCP &middot; Workflow Automation
</p>
...
- **AI agents** that use tools, call APIs, and handle multi-step tasks, built with LangChain, Google ADK, and modern agent SDKs
- **RAG chatbots and Q&A systems** grounded in your own documents and data (vector databases)
- **Workflow automation** connecting tools like email, CRM, and Slack, including with n8n
- **Reliable, structured outputs** through careful prompt engineering and tool-calling logic
- **LLM and third-party API integration** into working, production apps
- **Fast MVPs** to prove out an AI idea before committing to the full build
